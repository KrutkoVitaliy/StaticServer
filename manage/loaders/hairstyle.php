...
if (isset($_POST['tags']) and $_POST['tags'] != '') $tags = $_POST['tags'];
if (isset($_POST['hairstyle_type']) and $_POST['hairstyle_type'] != '') $hairstyle_type = $_POST['hairstyle_type'];
if (isset($_POST['face_type']) and $_POST['face_type'] != '') $face_type = $_POST['face_type'];
if (isset($_POST['lenght']) and $_POST['lenght'] != '') $lenght = $_POST['lenght'];
...
($row[0]+1),1,'".$tags."','".$hairstyle_type."','".$screen0."','".$screen1."','".$screen2."','".$screen3."',
'".$screen4."','".$screen5."','".$screen6."','".$screen7."','".$screen8."','".$screen9."','f',0,'".$uploadDate."'
)");

if ($result) {
    print "<html><head><meta http-equiv='refresh' content='0;URL=http://195.88.209.17/manage/index.php?cat=hairstyle'></head></html>";
}
else
print "<br>".$tags;
print "<br>".$screen1;
