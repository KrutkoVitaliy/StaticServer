<table cellpadding="2" width="100%">
    ...
    $flag = "f";
    $result = pg_query($connection, "SELECT * FROM manicure WHERE published LIKE '%$flag%' ORDER BY id LIMIT $limit OFFSET $offset");
    while ($row = pg_fetch_row($result)) {
            ...
            <td align='center' style='border-bottom: 1px dotted #808080'>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style='padding-right: 10px'>
                        <form action='http://195.88.209.17/manage/actions/edit.php' method='post' enctype='multipart/form-data'>
                            <input type='hidden' name='id' value='%s'>
                            <input type='hidden' name='type' value='manicure'>
        ...
        ", $profileResult[0], $profileResult[1], $profileResult[2], $replaced,
            ...
            $shape, $design, $row[0], $row[0], $row[0]);
